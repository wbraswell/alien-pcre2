...
print {*STDERR} "\n\n", q{<<< DEBUG >>> have $version_split_1 = '}, $version_split_1, q{'}, "\n\n";
my $version_split_1_split = [split /[.]/, $version_split_1];
print {*STDERR} "\n\n", '<<< DEBUG >>> have $version_split_1_split =', Dumper($version_split_1_split), "\n\n";
my $version_split_1_split_0 = $version_split_1_split->[0] + 0;
print {*STDERR} "\n\n", q{<<< DEBUG >>> have $version_split_1_split_0 = '}, $version_split_1_split_0, q{'}, "\n\n";
