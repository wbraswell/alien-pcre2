...
#print {*STDERR} "\n\n", q{<<< DEBUG >>> in t/04_pcre2grep.t, have $pcre2_bin_dir = '}, $pcre2_bin_dir, q{'}, "\n\n";
...
#print {*STDERR} "\n\n", q{<<< DEBUG >>> in t/04_pcre2grep.t, have $pcre2_path = '}, $pcre2_path, q{'}, "\n\n";
...
#print {*STDERR} "\n\n", '<<< DEBUG >>> in t/04_pcre2grep.t, have $version =', Dumper($version), "\n\n";
cmp_ok((scalar @{$version}), '==', 1, '`pcre2grep --version` executes with 1 line of output');

my $version_0 = $version->[0];
#print {*STDERR} "\n\n", q{<<< DEBUG >>> in t/04_pcre2grep.t, have $version_0 = '}, $version_0, q{'}, "\n\n";
...
#print {*STDERR} "\n\n", '<<< DEBUG >>> in t/04_pcre2grep.t, have $version_split =', Dumper($version_split), "\n\n";
my $version_split_0 = $version_split->[0] + 0;
#print {*STDERR} "\n\n", q{<<< DEBUG >>> in t/04_pcre2grep.t, have $version_split_0 = '}, $version_split_0, q{'}, "\n\n";
