...
#    $pcre2_path = can_run('pcre2-config');  # NEED FIX: Windows hack, why can't Windows find this file?!?
    $pcre2_path = can_run('pcre2grep');
print {*STDERR} "\n\n", q{<<< DEBUG >>> in t/02_pcre2_config.t, WINDOWS HACK PART 1, NEED FIX WINDOWS INABILITY TO FIND pcre2-config FILE!!!}, "\n\n";
}
else {
...
print {*STDERR} "\n\n", q{<<< DEBUG >>> in t/02_pcre2_config.t, WINDOWS HACK PART 2, NEED FIX WINDOWS INABILITY TO FIND pcre2-config FILE!!!}, "\n\n";
